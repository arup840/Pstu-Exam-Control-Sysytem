  ...
  margin: 0;
    ...
    <body>
        ...
        <%
            ...
            String sm = null;
            try {
                if (Semester.equals("1st Semester(Level-1 Semester-I)") || Semester.equals("3rd Semester(Level-2 Semester-I)") ||Semester.equals("5th Semester(Level-3 Semester-I)") ||Semester.equals("7th Semester(Level-4 Semester-I)")) {
                    sm = "January-June";
                }
                else {
                    sm="July-December";
        ...
        %>
        <h3 align="center"><%out.println(Semester);%>Final Examination of B.Sc.Engg.(CSE)<%out.println(sm);%>  </h3>
        <table  style="border-collapse:collapse" cellspacing="0" cellpadding="2" border="1" >
            ...
            <%
                ...
                try {
                    ...
                    Class.forName("com.mysql.jdbc.Driver");
                    Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/pstu", "root", "");
                    PreparedStatement ps1 = conn.prepareStatement("SELECT * FROM courses1 WHERE Course_Code LIKE '%"+semester2+"_'");
        ...
        <table style="width: 100%">
            <tr><td>
                ...
                <td><span style="text-decoration: overline">Controller Of Examinations</span> </td>
                 ...
                 <p align="center"><button onclick="pt('a')">Print</button></p>
    </body>
</html>
